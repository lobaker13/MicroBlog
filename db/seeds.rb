...
User.create [(
  ...
  {id: 4, first_name: "Poison", last_name: "Ivy", email: "Itchy_plants@DC.com", username: "  " password: "plants_be_cool", super_id: 9}
  ...
  {id: 13, first_name: "Oswald", last_name: "Cobblepot", email: "DevitoPlayedMe@DC.com", username: "penguin" password: "richer_than_wayne", super_id: 10, universe_id: 2}
  )]
...
Post.create [(
  ...
  {id: 2, user_id: 2, title: "Exams", body: "Finals can be such a Loki.....am I right?.."}
  {id: 3, user_id: 3, title: "So I've heard...", body: "I heard that this Batman character is literally the best"}
  {id: 4, user_id: 4, title: "Feeling really withered rn", body: "omg. fml. smdh."}
  {id: 5, user_id: 13, title: "Umbrellas", body: "Umbrellas are the most effective weapons. Also, very practical on drizzly days."}
)]

Comment.create [(
  {id: 1, user_id: 2, body: "What a lame post, Captain..."}
  {id: 2, post_id: 3, user_id: 13, body: "rofl"}
)]
>>>>>>> c0f861fca34499464925e170aadbaa9b025fc89e
